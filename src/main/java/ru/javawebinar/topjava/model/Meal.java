...
@NamedQueries({
        ...
        @NamedQuery(name = Meal.SORTED, query = "SELECT m FROM Meal m WHERE m.user.id=:userId  " +
...
public class Meal extends AbstractBaseEntity {
    ...
    public static final String SORTED = "Meal.sortedByDateTime";
    ...
    @Min(value = 10, message = "Значение должно быть от 10 до 5000")
    @Max(value = 5000, message = "Значение должно быть от 10 до 5000")
